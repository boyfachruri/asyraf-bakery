    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a class="logo-link nk-sidebar-logo">
                <img class="logo-dark logo-img" src="{{ url('assets/images/asyraf-logo/asyraf-bakery.png') }}"
                    alt="logo">
                    ...
                    @if (Auth::user()->tipe_akun === 'kasir')
                        ...
                        <li class="nk-menu-item has-sub">
                            ...
                            <ul class="nk-menu-sub">
                                <li class="nk-menu-item">
                                    <a href="/penjualan" class="nk-menu-link"><span class="nk-menu-text">Data
                                            Penjualan</span></a>
                                </li>
                                <li class="nk-menu-item">
                                    <a href="/transaksi-penjualan" class="nk-menu-link"><span
                                            class="nk-menu-text">Transaksi Penjualan</span></a>
                                </li>
                            </ul>
                        </li>
                    @else
